...
import { ShoppingCart, X, Trash2, Plus, Minus, CalendarCheck, AlertTriangle, Phone } from "lucide-react";
...
const CartSidebar = () => {
  ...
  const saveOrder = () => {
    ...
    const order = {
      ...
      deliverySchedule: {
        date: deliverySchedule.date ? format(deliverySchedule.date, "yyyy-MM-dd") : "",
